...
////////////////////////////////////// настройка пинов /////////////////////////////////////
#define DISP_CS_SELECT      HAL_GPIO_WritePin(GPIOA, CS_Pin, GPIO_PIN_RESET)
#define DISP_CS_UNSELECT    HAL_GPIO_WritePin(GPIOA, CS_Pin, GPIO_PIN_SET)
#define DISP_DC_DATA        HAL_GPIO_WritePin(GPIOA, DC_Pin, GPIO_PIN_SET)
#define DISP_DC_CMD         HAL_GPIO_WritePin(GPIOA, DC_Pin, GPIO_PIN_RESET)
#define DISP_RST_RESET      HAL_GPIO_WritePin(GPIOA, RESET_Pin, GPIO_PIN_RESET)
#define DISP_RST_WORK       HAL_GPIO_WritePin(GPIOA, RESET_Pin, GPIO_PIN_SET)
